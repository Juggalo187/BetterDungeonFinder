...
BAFLang_SI = {
  ...
  SETTING_Other_LeaveGroupPopup = "Окно выхода из группы",
  SETTING_Other_LeaveGroupPopup_Info = "Автоматически открывать окно выхода из группы после завершения активности",
